                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-3 col-md-3">
                    ...
                    <div class="cart-qty"> <span>Qty : </span>
                      <input type="number" max="10" min="1" value="{{$pro->qty}}" class="qty-fill" id="upCart{{$pro->id}}">
                    </div>
                ...
                <div class="chk-coupon">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <input type="button" class="btn btn-primary fld-btn" value="Redeem Coupon" id="coupon_btn" />
                    </span>
                  </div>
                </div>
              </div>
