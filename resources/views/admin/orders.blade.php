    ...
    <div class="row row_body">
      ...
      <div class="col-md-2 col-xs-2 col-sm-2">
        ...
        <select class="form-control" id="order_status<?php echo $countOrder; ?>">
          <option value="pending" <?php if ($order->status == 'pending') { ?> selected="selected" <?php } ?>>pending</option>

          <option value="dispatched" <?php if ($order->status == 'dispatched') { ?> selected="selected" <?php } ?>>dispatched</option>

          <option value="processed" <?php if ($order->status == 'processed') { ?> selected="selected" <?php } ?>>processed</option>

          <option value="shipping" <?php if ($order->status == 'shipping') { ?> selected="selected" <?php } ?>>shipping</option>

          <option value="cancelled" <?php if ($order->status == 'cancelled') { ?> selected="selected" <?php } ?>>cancelled</option>

          <option value="delivered" <?php if ($order->status == 'delivered') { ?> selected="selected" <?php } ?>>delivered</option>
        </select>
