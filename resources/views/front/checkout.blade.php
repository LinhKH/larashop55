  ...
  <div class="container">
    ...
    <div class="row ">
      ...
      <form action="{{url('/placeOrder')}}" method="post">
        ...
        <div class="form-group">
          <div class="col-md-6">
            <!-- First name -->
            <input type="text" class="form-control" placeholder="Full name" name="fullname" value="{{Auth::user()->name}}">
          ...
          <div class="col-md-6">
            ...
            <br> <br>
            <textarea class="form-control" rows="5" placeholder="Full Address" name="fullAddress"></textarea>
              ...
              <div class="cart-row">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 text-center">
                    <img src="{{Config::get('app.url')}}/public/img/{{$pro->options->img}}" class="img-responsive pull-left" width="100px" />
                  ...
                  <div class="col-xs-12 col-sm-3 col-md-3">
                    ...
                    <a href="{{url('cart/remove')}}/{{$pro->rowId}}" class="cart-remove btn btn-danger">Remove</a>
                  </div>
                  <div class="col-xs-12 col-sm-3 col-md-3">
                    <h6>Unit Price</h6>
                    <p>${{$pro->price}}
    ...
    <div class="row">
      <div class="col-md-2 col-md-offset-5 top25">
        <img src="{{Config::get('app.url')}}/public/img/empty-cart-page-doodle.png" class="img-response" />
        <br><br>
        <p style="text-align:center">Nothing in the bag<br><br>
          <a href="{{url('products')}}" class="btn btn-fill btn-primary">Continue Shopping</a>
        </p>
